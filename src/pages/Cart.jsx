          ...
          <div>
            ...
            <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
              ...
              <div className='flex justify-between items-center'>
                <h1 className='flex items-center gap-1 text-gray-700'><span><LuNotebookText /></span>Items total</h1>
                <p>${getTotalPrice}</p>
              </div>
              <div className='flex justify-between items-center'>
                <h1 className='flex items-center gap-1 text-gray-700'><span><MdDeliveryDining /></span>Delivery Charge</h1>
                <p className='text-red-500 font-semibold'><span className='text-gray-600 line-through'>$25</span> FREE</p>
              </div>
              <div className='flex justify-between items-center'>
                <h1 className='flex items-center gap-1 text-gray-700'><span><GiShoppingBag /></span>Handling Charge</h1>
                <p className='text-red-500 font-semibold'>$5</p>
              </div>
              <hr className='text-gray-200 mt-2'/>
              <div className='flex justify-between items-center'>
                <h1 className='font-semibold text-lg'>Grand Total</h1>
                <p className='font-semibold text-lg'>${getTotalPrice + 5}</p>
              </div>
              <div>
                ...
                <div className='flex gap-3'>
                  ...
                  <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md'>Apply Code</button>
                </div>
              </div>
