...
const SingleProduct = () => {
  ...
  const originalPrice = Math.round(singleProduct?.price || 0) + ((singleProduct?.price || 0) * (singleProduct?.discount || 0) / 100)
  ...
  return (
    <>
      ...
      singleProduct ? 
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-xl text-red-500 font-bold">${singleProduct.price} 
                ...
                <div className="flex items-center gap-4">
                  ...
                  min={1} 
                  value={1}
                  className="w-20 bordr border-gray-300 rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-red-500" 
                  />
                </div>
       ...
       : 
        <div classNme="flex items-center justify-center h-screen">
